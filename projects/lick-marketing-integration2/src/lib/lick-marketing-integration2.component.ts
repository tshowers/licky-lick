...
@Component({
  selector: 'licky-lick-marketing-integration2',
  templateUrl: './lick-marketing-integration2.component.html',
  styles: []
})
export class LickMarketingIntegration2Component implements OnInit {
