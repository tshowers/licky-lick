...
export class LickAppWidgetPost4Component implements OnInit {
  ...
  @Input() heading4 = "Heading4";

  @Input() subFeaturedData1: any[] = [
    {
  ...
  @Input() subFeaturedData3;
  @Input() subFeaturedData4;

  @Input() featuredData1: any =
    {
      "id": Math.floor(Math.random() * 1000),
      "heading": "Technology",
