...
@Component({
  selector: 'licky-lick-marketing-latest-post2',
  templateUrl: './lick-marketing-latest-post2.component.html',
  styles: []
})
export class LickMarketingLatestPost2Component implements OnInit {
