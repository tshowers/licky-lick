...
@Component({
  selector: 'licky-lick-marketing-prices2',
  templateUrl: './lick-marketing-prices2.component.html',
  styles: []
})
export class LickMarketingPrices2Component implements OnInit {

  @Input() headingText = "llicky-lick-marketing-prices2";
